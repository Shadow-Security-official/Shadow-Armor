...
func (a *app) list(args []string) error {
	...
	f.BoolVar(&showPillars, "pillars", false, "list the pillars")
...
func (a *app) controlsMarkdown() error {
	...
	fmt.Fprintf(w, "# Shadow-Armor controls\n\n%d controls in %d pillars. Level 1 is the baseline (`--level 1`, default), level 2 adds hardened controls.\n", len(c.Controls), len(c.Pillars))
